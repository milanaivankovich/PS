...
urlpatterns = [
    ...
    path('api/advertisements/businesssubject/<int:business_subject_id>/', get_advertisements_by_business_subject, name='get_advertisements_by_business_subject'), #GET advertisements by business subject id
